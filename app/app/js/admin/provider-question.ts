module app {
    ...
    export class ProviderQuestion {
        ...
        public refresh() {
            this.AppUtil.blockingCall(
                this.AppService.getProviderQuestions(),
                questions => {
        ...
        public addClinicsQuestion(form) {
            ...
            if (form.$valid) {
                this.AppUtil.blockingCall(
                    this.AppService.addProviderQuestions(this.clinicQuestion),
                    () => {
                        this.modalText = "New "
        ...
        public deleteQ(id) {
            this.AppUtil.blockingCall(
                this.AppService.delProviderQuestions(id),
                () => {
    ...
    ProviderQuestion.$inject = ['$ionicPopup', '$log', '$scope', '$state', '$ionicModal', 'AppService', 'AppUtil']
    angular.module('controllers').controller('ProviderQuestion', ProviderQuestion)
}
