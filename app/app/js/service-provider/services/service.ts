module app {
	...
	export class SpViewService {
		...
		constructor(private $scope, private $state, private $stateParams, private SpService,
		private $sce, private $ionicPopup, private AppUtil, private AppService, private $ionicHistory) {
