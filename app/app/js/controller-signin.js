...
angular.module('controllers', ['service.app', 'ngAnimate', 'ngCordova', 'ionic.contrib.ui.tinderCards', 'ngCordovaOauth'])

    .controller('SignInCtrl', function ($scope, $log, $rootScope, $state, $http, $timeout, $cordovaFacebook, $q, $ionicPopup,
                                        $ionicModal, $ionicLoading, $ionicHistory, AppService, AppUtil, SocialAuth, $cordovaOauth,
        ...
        $scope.linkedInLogin = function () {
            ...
            $cordovaOauth.linkedin(linkedInId, linkedInSecret, ['r_basicprofile', 'r_emailaddress'], 'rtbwrtusgfxytr')
